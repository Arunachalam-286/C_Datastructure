...
// Structure for a binary tree node with horizontal distance
...
void printTopView(struct Node* root) {
    ...
    // Map to store the topmost nodes at each horizontal distance
    int minHD = 0, maxHD = 0;
    int topView[1000] = {0}; // Adjust size for a larger tree
    int visited[1000] = {0};
